            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                  <Link
                    href="/salesman"
                    className="hover:text-[#B39371] transition-colors"
                  >
                    {t("salesman.title")}
                  </Link>
                        ...
                        <div className="flex items-center gap-2">
                          <div
                            className={cn(
                              ...
                              new Date(salesman.endDate) > new Date()
                                ? "bg-emerald-500"
                                : "bg-rose-500",
                            )}
                          />
                  ...
                  <div className="space-y-6">
                    <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-md border border-gray-100 dark:border-gray-800">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-gray-500">
                          {t("salesman.stats.totalContracts")}
                        </span>
                      </div>
                    ...
                    <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-md border border-gray-100 dark:border-gray-800">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-gray-500">
                          {t("salesman.stats.totalApartmentContracts")}
                        </span>
                      </div>
                      <span className="text-lg font-black text-gray-900 dark:text-white">
                        {apartmentContractsCount}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center p-4 bg-emerald-50 dark:bg-emerald-500/5 rounded-md border border-emerald-100 dark:border-emerald-500/10">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-emerald-700/70">
                          {t("salesman.stats.totalContractValue")}
                        </span>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-5 bg-[#4A1B1B]/5 dark:bg-[#4A1B1B]/10 rounded-md border border-[#4A1B1B]/10 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-gray-600 dark:text-gray-400">
                          {t("salesman.stats.totalCommission")}
                        </span>
                      </div>
                      <div className="text-right">
                        ...
                        <span className="text-[10px] font-bold text-[#B39371] uppercase ml-1">
                          {t("common.sar")}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-5 bg-emerald-50 dark:bg-emerald-500/5 rounded-md border border-emerald-100 dark:border-emerald-500/10 flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-[10px] font-bold text-emerald-600 uppercase ml-1">
                          {t("common.sar")}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-white dark:bg-gray-800/50 rounded-md border border-gray-100 dark:border-gray-700 space-y-1">
                    ...
                    {salesman.createdBy && (
                      <div className="flex items-center justify-between mt-1 pt-1 border-t border-gray-50 dark:border-gray-800">
                        ...
                        <span className="text-[9px] font-bold text-[#B39371]">
                          {salesman.createdBy.email}
                        </span>
                      </div>
                    )}
                  </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-800/50">
                  <tr>
                    <th className="px-8 py-4 text-left rtl:text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("contracts.labels.client")}
                    </th>
                    <th className="px-8 py-4 text-left rtl:text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("contracts.labels.apartment")}
                    </th>
                    <th className="px-8 py-4 text-left rtl:text-right text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("contracts.labels.contractDate")}
                    </th>
                    <th className="px-8 py-4 text-right rtl:text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("contracts.labels.paidAmount")}
                    </th>
                  </tr>
                </thead>
                        ...
                        <td className="px-8 py-5">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
                              {i18n.language === "ar"
                                ? contract.apartment?.mainName?.arabic
                                : contract.apartment?.mainName?.english}
                            </span>
                          </div>
                        </td>
