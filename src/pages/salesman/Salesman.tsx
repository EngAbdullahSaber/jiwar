    ...
    queryFn: async () => {
      const response = await api.get("/salesman", {
        params: {
          ...
          agentType:
            filters.agentType !== "all" ? filters.agentType : undefined,
        },
      });
        ...
        return (
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-[10px] text-gray-400">
              ...
              {salesman.totalPaidToSalesman.toLocaleString()}
            </span>
          </div>
        );
      },
    ...
    },
    {
      ...
      cell: (salesman) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-48 rounded-md border-gray-200 dark:border-gray-800 shadow-xl p-1"
          >
    ...
    <Shell>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={cn("p-3 rounded-md transition-colors", stat.bg)}
                  >
          ...
          {/* Empty State */}
          {!isLoading &&
            (!data?.data?.salesmen || data.data.salesmen.length === 0) && (
              <motion.div
