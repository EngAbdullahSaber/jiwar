  ...
  const features = [
    {
      ...
      icon: DoorOpen,
      active: template.duelEntrances,
    },
    {
      key: "familyLounge",
      label: t("templates.amenities.familyLounge"),
      icon: Users,
      active: template.familyLounge,
    },
    {
      key: "guestMajlis",
      label: t("templates.amenities.guestMajlis"),
      icon: Coffee,
      active: template.guestMajlis,
    },
    {
      key: "kitchen",
      label: t("templates.amenities.kitchen"),
      icon: Utensils,
      active: template.kitchen,
    },
    {
      key: "balconyAccess",
      label: t("templates.amenities.balcony"),
      icon: Wind,
      active: template.balconyAccess,
    },
    {
      key: "rooftop",
      label: t("templates.amenities.rooftop"),
      icon: Home,
      active: template.rooftop,
    },
  ];
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[#B39371] border-[#B39371]/20"
                    >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              >
                {imageUrl ? (
                  <img
                    src={
                      imageError ? getPlaceholderImage(template.id) : imageUrl
                    }
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <DetailItem
                    ...
                    value={template.modelType}
                  />
                  <DetailItem
                    icon={MapPin}
                    label={t("templates.location")}
                    value={t(`templates.${template.location.toLowerCase()}`)}
                  />
                ...
                >
                  <div className="p-6 border-b border-gray-100 dark:border-gray-800">
                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white">
                      {t("templates.sections.visualAssets")}
                    </h4>
                  </div>
                  <div className="p-6">
                    <a
