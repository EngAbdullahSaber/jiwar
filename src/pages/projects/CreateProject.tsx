...
export default function CreateProject() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.projectIdentity)
      newErrors.projectIdentity = t("projects.errors.fieldRequired");
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Project ID */}
                <FormField
                  label={t("projects.labels.projectId")}
                  required
                  error={errors.projectIdentity}
                >
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setFormData({
                          ...formData,
                          projectIdentity: e.target.value,
                        });
                        if (errors.projectIdentity)
                          setErrors((p) => {
                            const { projectIdentity, ...r } = p;
                            return r;
                          });
                      }}
