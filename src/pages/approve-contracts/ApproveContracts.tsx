...
export default function ApproveContracts() {
  ...
  return (
    <Shell>
      ...
      >
        <DialogContent className="sm:max-w-[440px] rounded-md border border-[#B39371]/30 dark:border-[#B39371]/20 bg-white dark:bg-gray-900 p-0 overflow-hidden">
          <div className="p-6 border-b border-[#B39371]/20 dark:border-[#B39371]/10 bg-[#F5F1ED]/30 dark:bg-[#4A1B1B]/10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-md bg-[#F5F1ED] dark:bg-[#4A1B1B]/30 flex items-center justify-center text-[#B39371]">
          ...
          <DialogFooter className="p-4 border-t border-[#B39371]/20 dark:border-[#B39371]/10 bg-[#F5F1ED]/30 dark:bg-[#4A1B1B]/10 gap-3">
            <Button
              variant="ghost"
