            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">{t('roles.createRole')}</h1>
                ...
                >
                  ...
                  <div className="p-8 bg-gray-50/50 dark:bg-white/5 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between gap-6">
                    <div className="flex items-center gap-3 text-gray-400">
                      ...
                      <p className="text-[10px] font-bold uppercase tracking-widest">{t('roles.authorizedDeployment')}</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <Button
                        type="button"
