          ...
          <div className="bg-white dark:bg-gray-900 rounded-md border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
              ...
              <div className="space-y-6">
                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Step Content */}
                            <div className={cn(
                              "flex-1 bg-gray-50 dark:bg-gray-800 rounded-md p-6 border transition-all",
                              hasConflictStep 
                                ...
                                <div className="flex-1 space-y-4">
                                  ...
                                  {step.isDefault && step.nameAr && (
                                    <div className="space-y-1">
                                      ...
                                      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 h-10 rounded-md px-3 flex items-center text-sm text-gray-600 dark:text-gray-400" dir="rtl">
                                        {step.nameAr}
                                      </div>
                                    </div>
                                  )}
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-md p-4 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-md bg-[#B39371]/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 px-8 py-6 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-end gap-4">
                <Link href="/legality">
                  <button 
                    className="px-6 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md transition-colors"
                  >
                    {t('common.cancel')}
                  </button>
                </Link>
