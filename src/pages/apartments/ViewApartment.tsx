      ...
      <Shell>
        ...
        <div className="max-w-md mx-auto text-center py-24 px-4">
          ...
          <Link href="/apartments">
            <button className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 px-5 py-3.5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <Link href={`/apartments/${apartment.id}/edit`}>
                <motion.button
                  whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}
                  className="flex items-center gap-2 px-4 py-2 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                ...
                <div className="px-6 pt-6 pb-5 flex flex-col sm:flex-row items-start justify-between gap-4 border-b border-gray-100 dark:border-gray-800">
                  ...
                  <div className="sm:text-right shrink-0 p-4 rounded-xl bg-[#F5F1ED] dark:bg-gray-800 border border-[#E8DDD3] dark:border-gray-700">
                ...
                <div className="p-5">
                  <div className="grid grid-cols-3 gap-3 h-52">
                    {/* Main slot */}
                    <div className="col-span-2 relative rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-150 dark:from-gray-800 dark:to-gray-750 flex flex-col items-center justify-center border border-gray-200 dark:border-gray-700">
                      <div
                    ...
                    <div className="grid grid-rows-2 gap-3">
                      {[0, 1].map(i => (
                        <div key={i} className="relative rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-150 dark:from-gray-800 dark:to-gray-750 flex items-center justify-center border border-gray-200 dark:border-gray-700">
                          <div
                            className="absolute inset-0 opacity-[0.04] dark:opacity-[0.08]"
                            style={{ backgroundImage: 'repeating-linear-gradient(0deg,#000 0,#000 1px,transparent 0,transparent 20px),repeating-linear-gradient(90deg,#000 0,#000 1px,transparent 0,transparent 20px)' }}
                          />
                  ...
                  <div>
                    ...
                    {apartment.project ? (
                      <Link href={`/projects/${apartment.project.id}`}>
                        <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-100 dark:border-gray-800 hover:border-[#B39371]/40 hover:bg-[#F5F1ED]/40 dark:hover:bg-gray-800 transition-all group cursor-pointer">
                          <div className="w-8 h-8 rounded-lg bg-[#4A1B1B]/8 dark:bg-[#4A1B1B]/20 flex items-center justify-center shrink-0 bg-[#F5F1ED] dark:bg-gray-800">
                      ...
                      <div className="p-3 rounded-lg border border-dashed border-gray-200 dark:border-gray-700 text-center">
                  ...
                  {documents.length > 0 ? (
                    <div className="space-y-1">
                      {documents.map((doc, i) => (
                        ...
                        >
                          <div className={cn('w-8 h-8 rounded-lg flex items-center justify-center shrink-0', doc.bg)}>
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="flex gap-4">
                        <div className="w-3 h-3 rounded-full bg-[#B39371] border-2 border-white dark:border-gray-900 shrink-0 mt-0.5 relative z-10" />
                      ...
                      {apartment.updatedAt ? (
                        <div className="flex gap-4">
                          <div className="w-3 h-3 rounded-full bg-emerald-400 border-2 border-white dark:border-gray-900 shrink-0 mt-0.5 relative z-10" />
                          <div className="min-w-0">
                        ...
                        <div className="flex gap-4">
                          <div className="w-3 h-3 rounded-full bg-gray-200 dark:bg-gray-700 border-2 border-white dark:border-gray-900 shrink-0 mt-0.5 relative z-10" />
                          <div>
