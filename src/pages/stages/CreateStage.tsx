...
export default function CreateStage() {
  ...
  const createMutation = useMutation({
    mutationFn: async () => {
      ...
      const res = await api.post('/stage', payload);
      return res.data;
    },
    onSuccess: () => {
      toast.success(t('stages.createSuccess'), {
                    ...
                    <DatePicker
                      ...
                      onChange={date => {
                        ...
                        setErrors(p => {
                          ...
                          if (date && p.toDate === t('common.startDateBeforeEndDate') && formData.toDate && new Date(date) < new Date(formData.toDate))
                            delete next.toDate;
                          return next;
                        });
                      }}
