  ...
  return (
    <div className="flex items-center gap-3">
      <button 
        ...
        className={cn(
          "w-10 h-10 flex items-center justify-center rounded-md transition-all duration-300 shadow-sm border border-transparent",
      ...
      <div className={cn(
        "flex items-center gap-1.5 p-1 rounded-md border border-border/50",
        ...
        {[...Array(totalPages)].map((_, i) => (
          <button
            ...
            className={cn(
              "w-8 h-8 rounded-md text-xs font-black transition-all duration-500",
              currentPage === i + 1 
